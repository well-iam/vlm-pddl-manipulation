...
def generate_launch_description():
    ...
    sensors_3d_yaml = load_yaml(
        'franka_fr3_moveit_config', 'config/custom_sensors_3d.yaml'
    )
    ...
    moveit_simple_controllers_yaml = load_yaml(
        'franka_fr3_moveit_config', 'config/custom_fr3_controllers.yaml'
    )
    moveit_controllers = {
    ...
    rviz_base = os.path.join(get_package_share_directory(
        'real_franka_robot'), 'rviz')
    rviz_full_config = os.path.join(rviz_base, 'moveit.rviz') #change here for calibration: calibration.rviz
    ...
    ros2_controllers_path = os.path.join(
        ...
        'config',
        'custom_fr3_ros_controllers.yaml',
    )
    ...
    spawn_gravity_controller = Node(
        package='controller_manager',
        executable='spawner',
        namespace=namespace,
        arguments=['gravity_compensation_example_controller', '--inactive'],
        output='screen',
        condition=UnlessCondition(use_fake_hardware)
    )

    # MY_MOD: Changed "fr3_gripper" to "franka_gripper"
