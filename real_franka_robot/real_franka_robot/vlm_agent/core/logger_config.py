...
def setup_logging(level=logging.WARNING):
    """
    Configures the main logger (root logger) for the entire application.
    ...
    # Create a handler that sends logs to the console (sys.stdout)
    ...
    # their level to WARNING. This will hide their INFO and DEBUG messages
    # without affecting ours.
